...
class MyPubViewContent extends StatefulWidget {
  ...
  @override
  State<MyPubViewContent> createState() =>
      _MyPubViewContentState();
}
...
class _MyPubViewContentState
    extends State<MyPubViewContent> {
                       ...
                       const Spacer(),
                        PopupMenuButton(
                          child:  CustumTag(backgroundColor: Colors.grey.shade200, children:const [
                            Icon(Icons.more_vert, color: Colors.blue, size: 30,),
                          ]),
                          itemBuilder: (context) => [
