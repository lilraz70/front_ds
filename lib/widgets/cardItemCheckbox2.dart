...
class CardItemCheckBox2 extends StatefulWidget {
  const CardItemCheckBox2({Key? key, required this.position, required this.list, required this.convenience, required this.checkBoxValue}) : super(key: key);
 // const CardItem({Key? key, required this.position, required this.convenience,   }) : super(key: key);
  ...
  //final String title;
  @override
  State<CardItemCheckBox2> createState() => _CardItemCheckBox2State();
}

class _CardItemCheckBox2State extends State<CardItemCheckBox2> {
